#!/usr/bin/env python3
"""Run 50-case live benchmark on AMD MI300X for ClinSight CXR cases (host version)."""
import json, urllib.request, time, os, sys
from datetime import datetime
from pathlib import Path

# Load all 50 case IDs from demo_cases.json (host path)
DEMO_CASES_PATH = "/shared-docker/clinsight/backend/data/demo_cases.json"
RESULTS_DIR = "/shared-docker/clinsight/benchmarks/gpu_results/batch_50_cxr_live"
